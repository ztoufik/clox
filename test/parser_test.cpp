...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
            ...
            std::tuple(std::string_view("class test;"),ParseError(std::string("{ expected"),0)),
            std::tuple(std::string_view("class test\n{;"),ParseError(std::string("couldn't parse class body"),1)),
            std::tuple(std::string_view("if a){a();};"),ParseError(std::string("( expected"),0)),
            std::tuple(std::string_view("if (a {a();};"),ParseError(std::string(") expected"),0)),
            std::tuple(std::string_view("if (a) a();};"),ParseError(std::string("{ expected"),0)),
            std::tuple(std::string_view("if (a) {a();} else a;;"),ParseError(std::string("{ expected"),0)),
            ...
            std::tuple(std::string_view("class :{};"),ParseError(std::string("class identifier expected"),0)),
            std::tuple(std::string_view("class test:{};"),ParseError(std::string("parent class identifier expected"),0)),
            std::tuple(std::string_view("let :a;"),ParseError(std::string("variable identifier expected"),0)),
            std::tuple(std::string_view("let a:;"),ParseError(std::string("type identifier expected"),0)),
